...
<%@page import="com.cater.beans.converters.CatererConverter"%>
<%@page import="com.lmax.disruptor.util.Util"%>
<%@page import="com.cater.dto.beans.CatererAddress"%>
<jsp>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="resources/themes/assets/ico/favicon.ico">
    <title>Bootstrappage.com free templates</title>

    <!-- Bootstrap core CSS -->
    <link href="resources/themes/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="resources/themes/assets/css/carousel.css" rel="stylesheet">
  </head>
<!-- NAVBAR
================================================== -->
  <body>
          ...
          <div class="container">
            <div class="navbar-header">
             ...
             <%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
              <%@ page import="com.cater.dto.beans.Caterer" %>
              <% StringBuilder strBuild = new StringBuilder("sdfsd");
    		CatererConverter catConv = new CatererConverter();
             Caterer caterer = (com.cater.dto.beans.Caterer) request.getAttribute("caterer");
             if(caterer.getCatererAddresses()==null)
             {
            	 out.print("Empty found");
             }
             else
             {
            	 for(CatererAddress caterAdd : caterer.getCatererAddresses())
            	 {
            		 out.print(caterAdd.getAddressDetails().getLine1());
            	 }
             }
    		/* else return;
    		for(CatererAddress addressObj : caterer.getCatererAddresses())
    		{
    			strBuild.append(addressObj.getLat());
    		 } */
				%>
              <a class="navbar-brand" href="index.html"><%out.print(strBuild.toString());%></a>
              my name is antony gonsalvis
            </div>
      ...
      <div class="carousel-inner">
        <div class="item active">
          <script
			...
			%>
			<script>
			var myCenter=new google.maps.LatLng(<%out.print(lat+","+lng);%>);
			var marker;
			function initialize()
			{
			var mapProp = {
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="img-circle" src="resources/themes/assets/images/nepali-momo.png" alt="Generic placeholder image">
          <h2>Nepalese MOMO</h2>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="resources/themes/assets/images/burger.png" alt="Generic placeholder image">
          <h2>Burger</h2>
          <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. </p>
          <p><a class="btn btn-default" href="#" role="button">&pound;5 Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
		  <img class="img-circle" src="resources/themes/assets/images/gorkha-special-chicken.png" alt="Lam Tikka">
	...
	<div id="myCarousel1" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
         <div class="row">
        <div class="col-lg-4">
          <img src="resources/themes/assets/images/salate.png" alt="Generic placeholder image">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="resources/themes/assets/images/burger.png" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="resources/themes/assets/images/drinks.png" alt="Generic placeholder image">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
	...
	<div id="myCarousel2" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
         <img src="resources/themes/assets/images/chicken.png" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="resources/themes/assets/images/drinks_lussy.png" alt="Generic placeholder image">
          <h4>Drink</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
        ...
        <div class="item">
         <div class="row">
        <div class="col-lg-4">
          <img src="resources/themes/assets/images/chicken_fry.png" alt="Generic placeholder image">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img src="resources/themes/assets/images/fish-and-chips.png" alt="Generic placeholder image">
          <h4>Meal</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
	...
	<div id="myCarousel3" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="col-lg-4">
          <img src="resources/themes/assets/images/rice.png" alt="Generic placeholder image">
          <h4>Rice</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
        ...
        <div class="item">
         <div class="row">
        <div class="col-lg-4">
          <img src="resources/themes/assets/images/courinder.png" alt="Generic placeholder image">
          <h4>Salates</h4>
          <p><a class="btn btn-default" href="#" role="button">Add to cart &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
	...
	<div class="row">
		<div class="col-lg-4">
		<div class="media">
			<a href="menu/"><img src="resources/themes/assets/images/nepali-momo.png" alt="nepali-momo"> </a>
		...
		<div class="col-lg-4">
		<div class="media"><a href="menu/"><img src="resources/themes/assets/images/gorkha-special-chicken.png" alt="GURKHA SPECIAL CHICKEN"> </a>						
		...
		<div class="col-lg-4">
		<div class="media">
		<a href="menu/"><img src="resources/themes/assets/images/lam-tikka.png" alt="Lam Tikka"> </a>
...
$(document).ready(function(){
	var xhttp = new XMLHttpRequest();
	  xhttp.onreadystatechange = function() {
	    if (xhttp.readyState == 4 && xhttp.status == 200) {
	    	...
	    	tweetData objCast = new ObjectMapper().readValue(jsonData, tweetData.class);
	    document.getElementById("Description").innerHTML = objCast.max_id; 
	    }
	  };
	...
	<div class="introSection" id="Description">
		<div class="container">
		<div class="row">
		<div class="col-lg-5">
		<h3>Welcome to restaurent <%out.println(caterName);%> </h3>
		<p>
		Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy 
   ...
   <div id="myCarousel4" class="carousel slide" data-ride="carousel">
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img src="resources/themes/assets/images/fish-and-chips.png" alt="Fish and Chips">
        </div>
      </div>
      </div>
	...
	<div class="item">
      <div class="row featurette">
        ...
        <div class="col-md-5">
		  <img class="img-circle" src="resources/themes/assets/images/drinks.png" alt="Generic placeholder image">
        </div>
      </div>
      </div>
	   </div>
    ...
    <script src="resources/themes/dist/js/bootstrap.min.js"></script>
    <script src="resources/themes/assets/js/holder.js"></script>
  </body>
</html>
</jsp>